    ...
    BinaryXmlParser.prototype.readTypedValue = function() {
      ...
      switch (dataType) {
        ...
        default:
          ...
          logger.debug("Not sure what to do with typed value of type 0x" + type + ", falling back to reading an uint32");
      ...
      if (this.cursor !== end) {
        ...
        logger.debug("Cursor is off by " + diff + " bytes at " + this.cursor + " at supposed end of typed value of type 0x" + type + ". The typed value started at offset " + start + " and is supposed to end at offset " + end + ". Ignoring the rest of the value.");
        this.cursor = end;
      }
      return typedValue;
    };
    ...
    BinaryXmlParser.prototype.parse = function() {
      ...
      while (this.cursor < this.buffer.length) {
        ...
        if (this.cursor !== end) {
          ...
          logger.debug("Cursor is off by " + diff + " bytes at " + this.cursor + " at supposed end of chunk of type 0x" + type + ". The chunk started at offset " + start + " and is supposed to end at offset " + end + ". Ignoring the rest of the chunk.");
          this.cursor = end;
        }
      }
